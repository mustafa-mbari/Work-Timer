...
export function buildInvoiceReceiptEmail(params: {
  ...
  const content = `
    ...
    ${divider()}
    ${smallText('This receipt was generated automatically. If you have questions about this charge, contact us at support@w-timer.com.')}
  `

  return {
    subject: `Work Timer payment receipt - ${params.amount} ${params.currency.toUpperCase()}`,
