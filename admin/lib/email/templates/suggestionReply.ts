...
export function buildSuggestionReplyEmail(params: {
  ...
  const content = [
    ...
    paragraph('Thank you for helping us improve Work Timer. Your feedback is valuable to us!'),

    button('View Suggestions', `${WEBSITE_URL}/suggestions`),

    divider(),
    smallText('This email was sent in response to your feature suggestion on Work Timer.'),
  ].join('\n')
