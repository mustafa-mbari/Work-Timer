...
export function buildPasswordResetEmail(params: {
  ...
  const content = `
    ...
    ${paragraph(greeting)}
    ${paragraph('We received a request to reset your Work Timer password. Click the button below to choose a new password.')}
  ...
  return {
    subject: 'Reset your Work Timer password',
    html: wrapInBaseLayout(content, 'Reset your Work Timer password.'),
  }
}
