...
export default function DashboardTab() {
  ...
  const [failures, setFailures] = useState<DbEmailLog[]>([])
  ...
  return (
    <div className="space-y-6 mt-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Line chart: emails over 30 days */}
        <Card>
          <CardContent className="pt-5">
          ...
          <CardContent className="pt-5">
            ...
            <div className="space-y-2">
              {failures.map(f => (
                ...
                >
                  <div className="min-w-0">
                    <p className="text-sm font-medium text-stone-800 dark:text-stone-200 truncate">{f.recipient}</p>
                    <p className="text-xs text-rose-600 dark:text-rose-400 truncate">
                      {(f.error || 'Unknown error').slice(0, 100)}
                    </p>
                  </div>
