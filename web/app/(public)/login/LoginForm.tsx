        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-stone-800 dark:text-stone-200">{t('featureSecureTitle')}</p>
                <p className="text-sm text-stone-500 dark:text-stone-400">{t('featureSecureDesc')}</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-indigo-100 dark:bg-indigo-900/40 flex items-center justify-center text-indigo-600 dark:text-indigo-400">
              ...
              <div>
                <p className="text-sm font-semibold text-stone-800 dark:text-stone-200">{t('featureSyncTitle')}</p>
                <p className="text-sm text-stone-500 dark:text-stone-400">{t('featureSyncDesc')}</p>
              </div>
            </div>
          </div>
        </div>
