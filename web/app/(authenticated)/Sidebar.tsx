...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-52 shrink-0 border-r border-stone-200 dark:border-[var(--dark-border)] sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto px-3 py-6">
