...
export function buildSupportTicketEmail(params: {
  ...
  const content = `
      ...
      <tr>
        <td style="padding: 16px; background-color: #fef2f2; border-radius: 8px; border: 1px solid #fecaca;">
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr><td style="padding: 4px 0;"><strong style="color: #1c1917; font-size: 13px;">Platform:</strong> <span style="color: #44403c; font-size: 13px;">${params.platform}</span></td></tr>
            ${params.issueTime ? `<tr><td style="padding: 4px 0;"><strong style="color: #1c1917; font-size: 13px;">Issue Time:</strong> <span style="color: #44403c; font-size: 13px;">${params.issueTime}</span></td></tr>` : ''}
          </table>
        </td>
      </tr>
    </table>
    ...
    ${divider()}
    ${smallText('This ticket was submitted via the Work Timer website.')}
  `
