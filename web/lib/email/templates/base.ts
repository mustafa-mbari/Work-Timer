const LOGO_URL = 'https://w-timer.com/logos/WT_logoWithText.png'
          ...
          <tr>
            <td align="center" style="padding-bottom: 32px;">
              <a href="${WEBSITE_URL}" style="text-decoration: none;">
                <img src="${LOGO_URL}" alt="Work Timer" width="160" style="display: block; width: 160px; height: auto;">
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding-top: 32px; text-align: center;">
              <p style="margin: 0 0 8px; font-size: 13px; color: #a8a29e;">
                <a href="${WEBSITE_URL}" style="color: #78716c; text-decoration: none;">w-timer.com</a>
              </p>
              ...
              <p style="margin: 0; font-size: 11px; color: #d6d3d1;">
                &copy; ${new Date().getFullYear()} Work Timer. All rights reserved.
              </p>
            </td>
          </tr>
