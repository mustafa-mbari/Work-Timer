-- Migration 017: Add earnings_enabled column to projects
-- Allows users to toggle per-project whether it's included in earnings calculations

ALTER TABLE projects ADD COLUMN IF NOT EXISTS earnings_enabled BOOLEAN NOT NULL DEFAULT true;

-- Update the earnings RPC to filter by earnings_enabled
