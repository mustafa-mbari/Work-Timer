-- ============================================================
-- Migration 003: User analytics RPC function
-- Replaces 150+ lines of JS aggregation in
-- web/app/(authenticated)/analytics/page.tsx
-- ============================================================

-- Returns pre-aggregated analytics data for a single user
...
BEGIN
  ...
  -- Calculate streak (consecutive days with entries counting back from today)
  WITH daily AS (
