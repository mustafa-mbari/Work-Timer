-- Migration 019: Earnings fixes
-- 1. total_projects counts all earnings_enabled projects (not just those with entries)
-- 2. Entries < 1 minute (60000ms) are excluded from earnings
-- 3. Add daily_earnings breakdown for chart display
