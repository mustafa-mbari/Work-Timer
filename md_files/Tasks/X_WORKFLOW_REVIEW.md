...
Your task is to conduct a **deep technical audit** of the groups workflow and its surrounding system components, with a focus on identifying hidden risks, scaling bottlenecks, operational weaknesses, and architectural problems before they cause failures in production.

Some files/paths maybe you need: web/groups and admin/groups apps.
